...
We need
\[
  300*9.81=\frac{2H^2}{\mu(400+H)^2}2(.01)
\]
In order to lift this we need an H field of $174.768 H$.  Using Ampere's law we can find the current:
\[
  NI=H(.5+.2)
\]
If we use $N=100$
\[
  I=\frac{174.768(.7)}{100} = 1.22A
\]
